...
for inspection or handoff. Pass --output DIR to write a loadable project (project.yaml
plus resources.yaml) that round-trips back through the loader to the same graph.`,
