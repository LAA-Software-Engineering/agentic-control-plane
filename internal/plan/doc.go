...
// path (static or autonomous edges). Issue #191 attaches Workflow→step→Agent→tool.operation
// witnesses on effect-bound and effect-delta items without a parallel rendering path.
