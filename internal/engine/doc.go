...
// (tool name + arguments digest, not raw args) then `tool_execution` (duration, cost, success/error)
// after the tool returns, including Call failures (issue #161). Policy denial still records
