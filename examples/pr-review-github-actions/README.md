...
4. Configure **`OPENAI_API_KEY`**, set **`TERFYN_INSTALL: release`** in the workflow (this monorepo defaults to **`go-build`**), and pin **`TERFYN_VERSION`** to a release that includes the GitHub native tools you need (see [releases](https://github.com/LAA-Software-Engineering/terfyn/releases)).
